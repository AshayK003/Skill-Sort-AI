...
# Load models
rf_classifier_categorization = pickle.load(open('models/model.pkl', 'rb'))
tfidf_vectorizer_categorization = pickle.load(open('models/vectorizer.pkl', 'rb'))
...
def extract_skills_from_resume(text):
    ...
    'Java', 'C++', 'JavaScript', 'HTML','HTML5' 'CSS', 'React', 'Angular', 'Node.js', 'MongoDB', 'Express.js', 'Git',    'Research', 'Statistics', 'Quantitative Analysis', 'Qualitative Analysis', 'SPSS', 'R', 'Data Visualization', 'Matplotlib', 'Seaborn', 'Plotly', 'Pandas', 'Numpy', 'Scikit-learn', 'TensorFlow', 'Keras', 'PyTorch', 'NLTK', 'Text Mining',
